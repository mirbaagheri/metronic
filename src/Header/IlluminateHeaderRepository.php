...
class IlluminateHeaderRepository implements HeaderRepositoryInterface
{
    ...
    // Disable OR Enable Quick Sidebar
	public function QuickSidebar($value)
	{
		$this->quickSidebar = $value;
	}

    // Disable OR Enable Quick Sidebar
    public function PageActions($value)
    {
        $this->pageActions = $value;
    }
	...
	////////////////////////////////////////////////////////////////////////////////////////
	   /////////////////////////// [ Dropdowns Area - Start ] ///////////////////////////
	     /////////////////////////////////////////////////////////////////////////////
	public function AddDropdown($obj)
	{
		foreach($obj as $key=>$value)
		{
			array_push($this->Dropdowns,$this->$key($value));
		}
	}
//	protected function NewToggle($values)
//	{
//		return '<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
//                                    <i class="'.$values["icon"].'"></i>
//                                    <span class="badge badge-'.$values["badge"].'"> '.$values["content"].' </span>
//                                </a>';
//	}
//	protected function Inbox($value)
//	{
//		return '<!-- BEGIN INBOX DROPDOWN -->
//                            <!-- DOC: Apply "dropdown-dark" class after below "dropdown-extended" to change the dropdown styte -->
//							<li class="dropdown dropdown-extended dropdown-inbox dropdown-dark" id="header_inbox_bar">
//                                '.$this->NewToggle($value['Toggle']).'
...
//							<!-- END TODO DROPDOWN -->';
//	}
//	protected function Notification($value)
//	{
//		return '
...
//	}
	protected function dropdownUser($obj)
	{
        $this->userDropdown = '<!-- BEGIN USER LOGIN DROPDOWN -->
                            <!-- DOC: Apply "dropdown-dark" class after below "dropdown-extended" to change the dropdown styte -->
	...
	public function QuickSidebarHtml()
	{
	return '<!-- BEGIN QUICK SIDEBAR -->
	...
	public function PageActionsHtml()
	{
		if($this->pageActions == true)
	...
	public function QuickSidebarToggler()
	{
        if($this->quickSidebar == true)
			return '
	...
	{
	 if($this->Search)
	 	return '<form class="search-form" action="page_general_search_2.html" method="GET">
                        <div class="input-group">
	...
	protected function DropdownsRender()
	{
		$Result = NULL;
		foreach($this->Dropdowns as $key=>$value){$Result.= $value;}
		return $Result;
	}

	protected function RenderLists($LIST)
	{
		$RESULT = NULL;
	...
	{
		if($this->data_close_others) $this->data_close_others = "true";
                ...
                <div class="page-top">
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            '.$this->DropdownsRender().'
                            <li class="separator hide"> </li>
                            '.$this->userDropdown.'
                            '.$this->QuickSidebarToggler().'
